...
class PermissionsSeeder extends Seeder
{
    public function run()
    {
        ...
        Permission::create(['name' => 'list scanners']);
        Permission::create(['name' => 'view scanners']);
        Permission::create(['name' => 'create scanners']);
        Permission::create(['name' => 'update scanners']);
        Permission::create(['name' => 'delete scanners']);
